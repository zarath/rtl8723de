...
u32 rtw_hal_power_on(_adapter *padapter)
{
	...
	ret = padapter->HalFunc.hal_power_on(padapter);
...
void rtw_hal_enable_interrupt(_adapter *padapter)
{
	...
	if (padapter->HalFunc.enable_interrupt)
		...
		RTW_INFO("%s: HalFunc.enable_interrupt is NULL!\n", __func__);
...
void rtw_hal_disable_interrupt(_adapter *padapter)
{
	...
	if (padapter->HalFunc.disable_interrupt)
		...
		RTW_INFO("%s: HalFunc.disable_interrupt is NULL!\n", __func__);
#endif /* #if defined(CONFIG_PCI_HCI) || defined (CONFIG_SDIO_HCI) || defined (CONFIG_GSPI_HCI) */
}
...
void rtw_hal_clear_interrupt(_adapter *padapter)
{
	...
	if (padapter->HalFunc.clear_interrupt)
		...
		RTW_INFO("%s: HalFunc.clear_interrupt is NULL!\n", __func__);
#endif
}
